              ...
              connection.request.method === RequestMethod.Post)
              {
                ...
                if (connection.request.headers.get('Authorization') === 'Bearer ' + token) {
                  //update the user data
                    ...
                    let order1: Order =  {orderID: 1223, orderName:'Product One', orderValue:120, orderQuantity: 1, foreignKeyUserID: 1, orderDate: '02/23/2017'  };
                    let order2: Order = {orderID: 1323, orderName:'Widget Three', orderValue:80, orderQuantity: 2, foreignKeyUserID: 1, orderDate: '07/5/2016'  };
                    let order3: Order = {orderID: 5293, orderName:'Another Kind of Product', orderValue:250, orderQuantity: 1, foreignKeyUserID: 1, orderDate: '06/4/2016'  };
                    let order4: Order = {orderID: 32339, orderName:'First purchase', orderValue:20, orderQuantity: 1, foreignKeyUserID: 1, orderDate: '06/3/2015'  };
